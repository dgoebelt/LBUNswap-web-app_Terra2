        ...
        <section className="cryptocurrencies-section" id="components">
          ...
          <div className="cryptocurrencies-info-cards">
            <div className="info-card">
              ...
              />
              <h3 className="info-card__title">Terra Classic / Terra 2
              <br></br>and Solana</h3>
              <p className="info-card__description">
                Low fees, Fast Transactions
              </p>
              <a href="https://terrasco.pe/mainnet/address/terra1ulr678u52qwt27dsgxrftthq20a8v8t9s8f3hz5z8s62wsu6rslqyezul4" className="info-card__btn">
            ...
            <div className="info-card">
              <img
                ...
                className="info-card__icon"
              />
              <h3 className="info-card__title">CosmWasm
              <br></br>Ecosystem</h3>
              <p className="info-card__description">
            ...
            <div className="info-card">
              <img
                ...
                className="info-card__icon"
              />
              <h3 className="info-card__title">Token Bonding
              <br></br>Curve AMM</h3>
              <p className="info-card__description">
