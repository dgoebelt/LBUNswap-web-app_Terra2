...
const useAPI = () => {
  ...
  const loadTokens = useCallback(async (): Promise<TokenResult[]> => {
    ...
    res.push(JSON.parse('{"name" : "LUNC Burn Token", "symbol": "LBUN", "protocol" : "LBUN Project", "decimals" : 6, "contract_addr": "terra1ulr678u52qwt27dsgxrftthq20a8v8t9s8f3hz5z8s62wsu6rslqyezul4", "icon" : "https://raw.githubusercontent.com/lbunproject/LBUNswap-web-app_Terra2/ebcaed74119e206d9b84d3b44c4af00941c67549/public/images/others/LBUN.svg", "verified" : true}'))
    return res
  }, [service])
